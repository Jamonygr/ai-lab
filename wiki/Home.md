...
Welcome to the AI Lab wiki. Start with the [documentation index](README.md), then follow the runbooks for deployment, testing, and teardown.

## Fast links

| Page | Purpose |
|------|---------|
| [Documentation index](README.md) | Main map for the wiki. |
| [Deploy and test runbook](runbooks/deploy-and-test.md) | End-to-end setup, apply, and smoke testing. |
